      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-md">
          ...
          <p className="mt-6 text-center text-sm text-[var(--muted)]">
            Need access? <Link href="/contact?utm_source=site&utm_medium=link&utm_campaign=portal" className="underline">Contact us</Link>
          </p>
        </div>
      </section>
    );
    ...
    <section className="px-6 py-16">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 rounded-3xl border border-[var(--border)] bg-[var(--surface-soft)] p-6 text-center">
          ...
          <Link
            href="/contact?utm_source=site&utm_medium=link&utm_campaign=portal-support"
