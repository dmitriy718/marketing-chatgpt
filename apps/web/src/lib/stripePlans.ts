...
export const stripePlans: Record<string, StripePlan> = {
  marketing_launch_monthly: {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_MARKETING_LAUNCH_MONTHLY_PRICE_ID ?? null,
    mode: "subscription",
    amount: 75000,
    interval: "month",
  },
  marketing_momentum_monthly: {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_MARKETING_MOMENTUM_MONTHLY_PRICE_ID ?? null,
    mode: "subscription",
    amount: 150000,
    interval: "month",
  },
  marketing_scale_monthly: {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_MARKETING_SCALE_MONTHLY_PRICE_ID ?? null,
    mode: "subscription",
    amount: 300000,
    interval: "month",
  },
  web_design_starter_rental_monthly: {
    ...
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_STARTER_RENTAL_MONTHLY_PRICE_ID ?? null,
    mode: "subscription",
    amount: 14900,
    interval: "month",
  },
  web_design_starter_rental_annual: {
    ...
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_STARTER_RENTAL_ANNUAL_PRICE_ID ?? null,
    mode: "subscription",
    amount: 148800,
    interval: "year",
  },
  web_design_growth_rental_monthly: {
    ...
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_GROWTH_RENTAL_MONTHLY_PRICE_ID ?? null,
    mode: "subscription",
    amount: 29900,
    interval: "month",
  },
  web_design_growth_rental_annual: {
    ...
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_GROWTH_RENTAL_ANNUAL_PRICE_ID ?? null,
    mode: "subscription",
    amount: 299000,
    interval: "year",
  },
  web_design_storefront_rental_monthly: {
    ...
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_STOREFRONT_RENTAL_MONTHLY_PRICE_ID ?? null,
    mode: "subscription",
    amount: 49900,
    interval: "month",
  },
  web_design_storefront_rental_annual: {
    ...
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_STOREFRONT_RENTAL_ANNUAL_PRICE_ID ?? null,
    mode: "subscription",
    amount: 499000,
    interval: "year",
  },
  web_design_premium_build: {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_PREMIUM_BUILD_PRICE_ID ?? null,
    mode: "one_time",
    amount: 180000,
  },
  web_design_flagship_build: {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_WEB_DESIGN_FLAGSHIP_BUILD_PRICE_ID ?? null,
    mode: "one_time",
    amount: 350000,
  },
};
